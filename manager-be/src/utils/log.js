...
const defaultUrlMap = [
	...
	['/goods-classify/list', '获取商品分类'],
	['/goods-classify/add', '新增商品分类'],
	['/goods-classify/update', '更新商品分类'],
	['/goods-classify/delete', '删除商品分类'],

	['/reset-password/list', '获取密码重置列表'],
	['/reset-password/add', '新增密码重置'],
	['/reset-password/changeStatus', '账户密码状态修改']
]
